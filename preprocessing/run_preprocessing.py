...
#
music = AudioSlice(output_dir='../data/dev_set/music', output_filename_prefix='music_', fixed_length_s=10)
...
# NOISE
noise = AudioSlice(output_dir='../data/dev_set/noise', output_filename_prefix='noise_', fixed_length_s=10)
...
# CONVERSATIONS
dialog = AudioSlice(output_dir='../data/dev_set/dialog', output_filename_prefix='dialog_',
